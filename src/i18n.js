...
const UI = {
  sv: {
    ...
    assignedTomorrow: 'Tilldelad i morgon',
    assignedLineTomorrow: '{driver} är tilldelad {plate} i morgon.',
    assignedLineRouteTomorrow: '{driver} är tilldelad {plate} i morgon, rutt {route}.',
    assignedSeveralTomorrow: 'Flera förare är tilldelade den här bilen i morgon. Se till att ditt eget namn står i förarfältet.',
    changeQuestionTomorrow: '{assigned} är tilldelad {plate} i morgon. Har du ersatt föraren, och har du OK från OC eller Fleet Manager att byta bil?',
    changeQuestionRouteTomorrow: '{assigned} är tilldelad {plate} i morgon på rutt {route}. Har du ersatt föraren på rutten, och har du OK från OC eller Fleet Manager att byta bil?',
  ...
  en: {
    ...
    assignedTomorrow: 'Assigned tomorrow',
    assignedLineTomorrow: '{driver} is assigned to {plate} tomorrow.',
    assignedLineRouteTomorrow: '{driver} is assigned to {plate} tomorrow, route {route}.',
    assignedSeveralTomorrow: 'Several drivers are assigned to this vehicle tomorrow. Make sure your own name is in the driver field.',
    changeQuestionTomorrow: '{assigned} is assigned {plate} tomorrow. Were you swapped in for that driver, and do you have an OK from the OC or Fleet Manager to use this vehicle?',
    changeQuestionRouteTomorrow: '{assigned} is assigned {plate} tomorrow on route {route}. Were you swapped in on that route, and do you have an OK from the OC or Fleet Manager to use this vehicle?',
  ...
  ar: {
    ...
    assignedTomorrow: 'تخصيص الغد',
    assignedLineTomorrow: 'المركبة {plate} مخصّصة غدًا لـ {driver}',
    assignedLineRouteTomorrow: 'المركبة {plate} مخصّصة غدًا لـ {driver}، المسار {route}',
    assignedSeveralTomorrow: 'أكثر من سائق مخصّص لهذه المركبة غدًا. تأكّد من أن اسمك أنت هو المكتوب في خانة السائق.',
    changeQuestionTomorrow: 'المركبة {plate} مخصّصة غدًا لـ {assigned}. هل حللت محل هذا السائق، وهل لديك موافقة من منسّق العمليات (OC) أو مدير الأسطول (Fleet Manager) على استخدام هذه المركبة؟',
    changeQuestionRouteTomorrow: 'المركبة {plate} مخصّصة غدًا لـ {assigned} على المسار {route}. هل حللت محل هذا السائق على هذا المسار، وهل لديك موافقة من منسّق العمليات (OC) أو مدير الأسطول (Fleet Manager) على استخدام هذه المركبة؟',
  ...
  hi: {
    ...
    assignedTomorrow: 'कल के लिए असाइन',
    assignedLineTomorrow: 'कल वाहन {plate} {driver} को असाइन किया गया है।',
    assignedLineRouteTomorrow: 'कल वाहन {plate} {driver} को असाइन किया गया है, रूट {route}।',
    assignedSeveralTomorrow: 'कल इस वाहन के लिए एक से अधिक ड्राइवर असाइन हैं। ध्यान दें कि ड्राइवर फ़ील्ड में आपका अपना नाम हो।',
    changeQuestionTomorrow: 'कल वाहन {plate} {assigned} को असाइन है। क्या आपको इस ड्राइवर की जगह भेजा गया है, और क्या आपके पास यह वाहन चलाने के लिए OC या फ़्लीट मैनेजर की अनुमति है?',
    changeQuestionRouteTomorrow: 'कल रूट {route} पर वाहन {plate} {assigned} को असाइन है। क्या आपको उस रूट पर इस ड्राइवर की जगह भेजा गया है, और क्या आपके पास यह वाहन चलाने के लिए OC या फ़्लीट मैनेजर की अनुमति है?',
